...
`}
              >
                ...
                <span
                  className={` absolute right-full mr-3 px-2 py-1 bg-nexus-primary text-nexus-bg text-[14px] font-bold rounded whitespace-nowrap uppercase tracking-tighter pointer-events-none animate-label-loop`}
                >
                  {item.label}
                </span>
              </button>
